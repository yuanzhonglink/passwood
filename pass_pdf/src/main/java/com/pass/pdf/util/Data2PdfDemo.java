...
import com.pass.pdf.config.PageHeaderFooter;
import com.pass.pdf.config.Watermark;
 ...
 * @Date: 2021/6/16
 * @Description:
 *  1. 引用—https://blog.csdn.net/weixin_37848710/article/details/89522862
 */
public class Data2PdfDemo {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            // 4.向文档中添加内容
            new Data2PdfDemo().generatePDF(document);
    ...
    public void generatePDF(Document document) throws Exception {
        ...
        // 添加图片
        Image image = Image.getInstance("E:\\Local_Project\\passwood\\file\\photo.jpg");
